...
import { Search, Navigation, X } from 'lucide-react-native';
...
export default function HomeScreen() {
  ...
  const initializeHome = async () => {
    try {
      ...
      fetchNearbySpots(currentLocation.coords.latitude, currentLocation.coords.longitude);
  ...
  const handleGetDirections = () => {
    ...
    const url = Platform.select({
      ios: `${scheme}?daddr=${selectedSpot.latitude},${selectedSpot.longitude}`,
      android: `${scheme}${selectedSpot.latitude},${selectedSpot.longitude}`,
      default: `${scheme}/dir/?api=1&destination=${selectedSpot.latitude},${selectedSpot.longitude}`,
    });
